...
<html lang="en" dir="ltr">
  ...
  <body style="background-color:#f8f9fa;">
    ...
    <br>
    <center><h2>More information about <?php echo e($eventList->name); ?></h2></center>
...
<img src="<?php echo e(asset('phpmyadmin/uploads/eventPhoto/'.$eventList->image)); ?>" alt=""height="auto" width="300">

</div>
  <h3><?php echo e($eventList->name); ?></h3></a>
  <h4>Location :  <?php echo $eventList->location; ?></h4>
  <h4>Price of Entry : <?php echo $eventList->noOfPeople; ?></h4>
  <h4>Description  : <?php echo $eventList->description; ?></h4>




  <form action="/eventList/<?php echo e($eventList->id); ?>/edit" class="form-inline my-2 my-lg-0">
...
<?php /**PATH /Users/krishnabhandari/.composer/vendor/bin/Events/resources/views/events/show.blade.php ENDPATH**/ ?>