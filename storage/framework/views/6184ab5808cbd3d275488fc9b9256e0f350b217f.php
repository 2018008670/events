...
<html lang="en" dir="ltr">
  <head>
    ...
    <a href="welcome">  <img src="logo.png" href= "welcome" alt="" class="center"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="navbar-brand" href="events">Event </a>
          </li>
          <li class="nav-item">
...
<div class="column">
      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
          ...
          <div class="hovereffect">
              <img class="img-responsive" src="ev2.jpg" alt="">
              <div class="overlay">
                 <h2>The Valvoline D1NZ National Drifting</h2>
                 <a class="info" href="#">More Info</a>
              </div>
          </div>
      </div>
...
<?php /**PATH /Users/krishnabhandari/.composer/vendor/bin/Events/resources/views/events.blade.php ENDPATH**/ ?>